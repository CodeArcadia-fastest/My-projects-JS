...
let checkbox = document.querySelector('.change-mode')
...
start.addEventListener("click", () => {
    ...
    for(let i = 0; i< count; i++){
        ...
        box.innerHTML = `
        <p class="title-uzb">${item['name-uzb']}</p>
        <img src="/pages/photos/${item['img']}" alt="" class="image">
        <p class="title-eng">${item['name-eng']}</p>
        `
...
if (cnt == true) {
    ...
    for(let i = 0; i< tanlanganlar.length; i++){
        ...
        <img src="photos/${tanlanganlar[i]['img']}" alt="" class="image">
        <p class="title-eng">${tanlanganlar[i]['name-eng']}</p>
        <div class="buttons">
        <button><</button>
        <button>></button>
    </div>
